...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Uwezocoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"uwezocointools.com", "testnet-seed.uwezocointools.com"},
    {"uwezocoin.org", "testnet-seed.uwezocoin.org"},   
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Uwezocoin is probably already running."), addrBind.ToString().c_str());
        else
